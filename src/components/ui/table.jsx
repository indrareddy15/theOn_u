...
export const TableHeader = ({ children, className = '', sticky = true }) => (
    <thead className={`[&_tr]:border-b ${sticky ? 'sticky top-0 z-30 bg-white shadow-sm' : ''} ${className}`}>
        {children}
    </thead>
);
...
export const TableRow = ({ children, className = '', onClick }) => (
    <tr
        className={`border-b transition-colors hover:bg-gray-50/50 data-[state=selected]:bg-gray-50 ${onClick ? 'cursor-pointer' : ''} ${className}`}
        onClick={onClick}
    >
        {children}
    </tr>
