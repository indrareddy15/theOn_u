...
import { Plus, Edit, Trash2, Star, MapPin, Ruler, Quote, Shield } from "lucide-react";
import {
...
export default function AdminContentManagement() {
    ...
    const handleSaveReview = async () => {
        ...
        try {
            if (editingReview) {
                await base44.entities.CustomerReview.update(editingReview.id, reviewForm);
    ...
    const handleSaveDisclaimer = async () => {
        ...
        try {
            if (editingDisclaimer) {
                await base44.entities.Disclaimer.update(editingDisclaimer.id, disclaimerForm);
    ...
    const handleSaveSizeChart = async () => {
        ...
        try {
            if (editingSizeChart) {
                await base44.entities.SizeChart.update(editingSizeChart.id, sizeChartForm);
    ...
    const addSizeRow = () => {
        setSizeChartForm({
            ...sizeChartForm,
            size_data: [...sizeChartForm.size_data, { size: '', chest: '', waist: '', length: '', shoulder: '' }]
        });
    };

    const updateSizeRow = (index, field, value) => {
        const newData = [...sizeChartForm.size_data];
        newData[index][field] = value;
        setSizeChartForm({ ...sizeChartForm, size_data: newData });
    };

    const removeSizeRow = (index) => {
        const newData = sizeChartForm.size_data.filter((_, i) => i !== index);
        setSizeChartForm({ ...sizeChartForm, size_data: newData });
    };
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setReviewForm({ ...reviewForm, display_order: parseInt(e.target.value) || 0 })}
                                                />
                                            </div>
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        onClick={() => setDeleteDialog({ open: true, type: 'review', id: review.id })}
                                                    >
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            ...
                            <Dialog open={disclaimerDialogOpen} onOpenChange={setDisclaimerDialogOpen}>
                                <DialogTrigger asChild>
                                    <Button onClick={resetDisclaimerForm}>
                                        <Plus className="w-4 h-4 mr-2" />
                                        Add Disclaimer
                                    </Button>
                                </DialogTrigger>
                                <DialogContent>
                                    <DialogHeader>
                                        <DialogTitle>{editingDisclaimer ? 'Edit' : 'Add'} Disclaimer</DialogTitle>
                                    </DialogHeader>
                                    <div className="space-y-4 mt-4">
                                        <div>
                                            <Label>Title *</Label>
                                            <Input
                                                ...
                                                onChange={(e) => setDisclaimerForm({ ...disclaimerForm, title: e.target.value })}
                                        ...
                                        <div>
                                            ...
                                            <Textarea
                                                ...
                                                onChange={(e) => setDisclaimerForm({ ...disclaimerForm, content: e.target.value })}
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={(e) => setDisclaimerForm({ ...disclaimerForm, icon: e.target.value })}
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={(e) => setDisclaimerForm({ ...disclaimerForm, position: e.target.value })}
                                                    className="w-full border rounded-md px-3 py-2"
                                                >
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setDisclaimerForm({ ...disclaimerForm, display_order: parseInt(e.target.value) || 0 })}
                                                />
                                            </div>
                                            <div className="flex items-center gap-2 pt-8">
                                                <input
                                                    ...
                                                    onChange={(e) => setDisclaimerForm({ ...disclaimerForm, is_active: e.target.checked })}
                                                    className="w-4 h-4"
                                                />
                                ...
                                <TableBody>
                                    {disclaimers.map(disclaimer => (
                                        <TableRow key={disclaimer.id}>
                                            ...
                                            <TableCell className="max-w-md truncate">{disclaimer.content}</TableCell>
                                            <TableCell>
                                                <Badge variant="outline" className="capitalize">{disclaimer.position}</Badge>
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        onClick={() => setDeleteDialog({ open: true, type: 'disclaimer', id: disclaimer.id })}
                                                    >
                                                        <Trash2 className="w-4 h-4 text-red-500" />
                                                    </Button>
                                                </div>
                ...
                <TabsContent value="sizecharts">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            ...
                            <Dialog open={sizeChartDialogOpen} onOpenChange={setSizeChartDialogOpen}>
                                <DialogTrigger asChild>
                                    <Button onClick={resetSizeChartForm}>
                                        <Plus className="w-4 h-4 mr-2" />
                                        Add Size Chart
                                    </Button>
                                </DialogTrigger>
                                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                                    <DialogHeader>
                                        <DialogTitle>{editingSizeChart ? 'Edit' : 'Add'} Size Chart</DialogTitle>
                                    </DialogHeader>
                                    <div className="space-y-4 mt-4">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setSizeChartForm({ ...sizeChartForm, category: e.target.value })}
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    onChange={(e) => setSizeChartForm({ ...sizeChartForm, unit: e.target.value })}
                                                    className="w-full border rounded-md px-3 py-2"
                                                >
                                                ...
                                                {sizeChartForm.size_data.map((row, index) => (
                                                    <div key={index} className="grid grid-cols-6 gap-2 items-center">
                                                        ...
                                                        <Input
                                                            placeholder="Chest"
                                                            value={row.chest}
                                                            onChange={(e) => updateSizeRow(index, 'chest', e.target.value)}
                                                        />
                                                        <Input
                                                            placeholder="Waist"
                                                            value={row.waist}
                                                            onChange={(e) => updateSizeRow(index, 'waist', e.target.value)}
                                                        />
                                                        <Input
                                                            placeholder="Length"
                                                            value={row.length}
                                                            onChange={(e) => updateSizeRow(index, 'length', e.target.value)}
                                                        />
                                                        <Input
                                                            placeholder="Shoulder"
                                                            value={row.shoulder}
                                                            onChange={(e) => updateSizeRow(index, 'shoulder', e.target.value)}
                                                        />
                                                        <Button
                                                            variant="ghost"
                                                            size="sm"
                                                            onClick={() => removeSizeRow(index)}
                                                            disabled={sizeChartForm.size_data.length === 1}
                                                        >
                                                            <Trash2 className="w-4 h-4 text-red-500" />
                                                        </Button>
                                                    </div>
                                                ))}
                                                <Button variant="outline" size="sm" onClick={addSizeRow} className="w-full">
                                                    <Plus className="w-4 h-4 mr-2" />
                                                    Add Size
                                                </Button>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <input
                                                ...
                                                onChange={(e) => setSizeChartForm({ ...sizeChartForm, is_active: e.target.checked })}
                                                className="w-4 h-4"
                                            />
                                ...
                                <TableBody>
                                    {sizeCharts.map(chart => (
                                        <TableRow key={chart.id}>
                                            <TableCell className="font-medium capitalize">{chart.category}</TableCell>
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        onClick={() => setDeleteDialog({ open: true, type: 'sizechart', id: chart.id })}
                                                    >
                                                        <Trash2 className="w-4 h-4 text-red-500" />
                                                    </Button>
                                                </div>
