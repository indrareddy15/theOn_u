// mockData.js
// Part-by-part mock data (no base44 client). Exports datasets + helpers for localStorage.

const STORAGE_KEYS = {
    categories: "mockCategories",
    products: "mockProducts",
    customerReviews: "mockCustomerReviews",
    disclaimers: "mockDisclaimers",
    orders: "mockOrders",
    banners: "mockBanners",
    coupons: "mockCoupons",
    addresses: "mockAddresses",
    sizeCharts: "mockSizeCharts",
    contentPages: "mockContentPages",
    reviews: "mockReviews",
    supportChats: "mockSupportChats",
    users: "mockUsers",
...
/* ---------------------------
   ...
   (trimmed / exactly your original objects)
   --------------------------- */
...
export const categoriesSeed = [
    {
        ...
        description:
            "Discover the latest trends in men's clothing and accessories with our premium collection",
    },
    {
        id: 2,
        ...
        description:
            "Elegant and stylish women's clothing collection for every occasion",
    },
    {
        id: 3,
        name: "Electronics",
        ...
        description:
            "Latest gadgets, smartphones, audio devices and electronic accessories",
    },
    {
        id: 4,
        name: "Home & Garden",
    ...
    },
    {
        ...
        description:
            "Sports equipment, fitness gear and athletic wear for an active lifestyle",
    },
    {
        id: 6,
        name: "Accessories",
        ...
        description:
            "Complete your look with stylish bags, watches, jewelry and more",
    },
    {
        id: 7,
        ...
        description:
            "Premium beauty products, skincare, makeup and personal care essentials",
    },
    {
        id: 8,
        name: "Books & Media",
...
// Products (complete array with all 30 products from base44Client.js)
...
// Customer reviews, disclaimers, orders, banners, coupons, addresses, sizeCharts, contentPages, reviews, supportChats, users, cartItems, wishlists
// For each dataset export a corresponding seed variable. Example below:

export const customerReviewsSeed = [
    {
        id: 1,
        customer_name: "Sarah Johnson",
        rating: 5,
        review_text:
            "Absolutely love the quality and style! Will definitely shop here again.",
    ...
    },
    {
        ...
        rating: 5,
        review_text:
            "Amazing shopping experience! The product quality exceeded my expectations.",
        location: "Houston, TX",
        is_active: true,
        display_order: 4,
    },
    {
        ...
        rating: 5,
        review_text:
            "Love the variety and trendy designs. My go-to online store now!",
        location: "Seattle, WA",
        is_active: true,
        display_order: 5,
    },
    {
        ...
        rating: 4,
        review_text:
            "Good quality products at reasonable prices. Quick delivery too.",
        location: "Phoenix, AZ",
        is_active: true,
        display_order: 6,
    },
    {
        ...
        rating: 5,
        review_text:
            "Fantastic customer support and premium quality items. Highly satisfied!",
        location: "Miami, FL",
        is_active: true,
        display_order: 7,
    },
    {
        ...
        rating: 4,
        review_text:
            "Great selection of electronics and accessories. Will shop again.",
        location: "Denver, CO",
        is_active: true,
        display_order: 8,
    },
    {
        ...
        rating: 5,
        review_text:
            "The silk dress I ordered was absolutely gorgeous! Perfect fit and quality.",
        location: "Boston, MA",
        is_active: true,
        display_order: 9,
    },
    {
        ...
        rating: 5,
        review_text:
            "Best online shopping experience! Fast shipping and great packaging.",
...
export const cartItemsSeed = [
    ...
    },
    {
        ...
        added_date: new Date(Date.now() - 3600000).toISOString()
    },
    {
        id: 3,
        user_email: "customer@test.com",
        ...
        selected_size: "10",
        selected_color: "white",
        added_date: new Date(Date.now() - 7200000).toISOString()
    },
    {
        id: 4,
        user_email: "john.doe@example.com",
        ...
        added_date: new Date(Date.now() - 10800000).toISOString()
    },
    {
        id: 5,
        user_email: "jane.smith@example.com",
        ...
        selected_size: "S",
        selected_color: "navy",
        added_date: new Date(Date.now() - 14400000).toISOString()
    }
];

// Wishlist Items
export const wishlistsSeed = [
    {
        id: 1,
        user_email: "customer@test.com",
        product_id: 2,
    ...
    },
    {
        ...
        user_email: "customer@test.com",
        product_id: 26,
        added_date: new Date(Date.now() - 6 * 86400000).toISOString()
    }
];
...
function saveIfMissing(key, seed) {
...
export function initMockData() {
    // Initialize everything only if missing
    saveIfMissing(STORAGE_KEYS.categories, categoriesSeed);
    saveIfMissing(STORAGE_KEYS.products, productsSeed);
    saveIfMissing(STORAGE_KEYS.customerReviews, customerReviewsSeed);
    saveIfMissing(STORAGE_KEYS.disclaimers, disclaimersSeed);
    saveIfMissing(STORAGE_KEYS.orders, ordersSeed);
    saveIfMissing(STORAGE_KEYS.banners, bannersSeed);
    saveIfMissing(STORAGE_KEYS.coupons, couponsSeed);
    saveIfMissing(STORAGE_KEYS.addresses, addressesSeed);
    saveIfMissing(STORAGE_KEYS.sizeCharts, sizeChartsSeed);
    saveIfMissing(STORAGE_KEYS.contentPages, contentPagesSeed);
    saveIfMissing(STORAGE_KEYS.reviews, reviewsSeed);
    saveIfMissing(STORAGE_KEYS.supportChats, supportChatsSeed);
    saveIfMissing(STORAGE_KEYS.users, usersSeed);
    saveIfMissing(STORAGE_KEYS.cartItems, cartItemsSeed);
    saveIfMissing(STORAGE_KEYS.wishlists, wishlistsSeed);

    console.log(
        "🔁 mockData: initMockData completed (only created missing keys)."
    );
}
...
export function clearAndReinitialize() {
    ...
    initMockData();
    console.log("🔄 mockData: cleared and reinitialized all mock data.");
}

// generic get / set helpers to interact with datasets
export function getMock(keyName) {
    const key = STORAGE_KEYS[keyName];
    if (!key) throw new Error("Invalid mock key: " + keyName);
    return JSON.parse(localStorage.getItem(key) || "[]");
}

export function writeMock(keyName, value) {
    const key = STORAGE_KEYS[keyName];
    if (!key) throw new Error("Invalid mock key: " + keyName);
...
// convenience getters
export const getCategories = () => getMock("categories");
export const getProducts = () => getMock("products");
export const getCustomerReviews = () => getMock("customerReviews");
export const getDisclaimers = () => getMock("disclaimers");
export const getOrders = () => getMock("orders");
export const getBanners = () => getMock("banners");
export const getCoupons = () => getMock("coupons");
export const getAddresses = () => getMock("addresses");
export const getSizeCharts = () => getMock("sizeCharts");
export const getContentPages = () => getMock("contentPages");
export const getReviews = () => getMock("reviews");
export const getSupportChats = () => getMock("supportChats");
export const getUsers = () => getMock("users");
export const getCartItems = () => getMock("cartItems");
export const getWishlists = () => getMock("wishlists");

/* ---------------------------
   Auto-init (optional)
   --------------------------- */
// Run initMockData automatically so importers get seeded data.
initMockData();
